...
namespace YKW1S_Mod_Tools
{
    public partial class MainForm : Form
    {
        ...
        private async void installADBToolStripMenuItem_Click(object sender, EventArgs e)
        {
            await InstallADB();
        }
        private async void importViaADBToolStripMenuItem_Click(object sender, EventArgs e)
        {
            await ImportViaADBAsync();
        }
        ...
        {
            StringSearchForm searchForStrings = new StringSearchForm();
        ...
        {
            ModPanelForm modPanel = new ModPanelForm();
            modPanel.Show();
        }
